package com.example.sbbloginfo.aop;

import com.example.sbbloginfo.entity.ExceptionLog;
import com.example.sbbloginfo.repository.ExceptionLogRepository;
...
public class ExceptionLoggingAspect {
  ...
  @AfterThrowing(pointcut = "execution(* com.example.sbbloginfo..*(..))", throwing = "exception")
