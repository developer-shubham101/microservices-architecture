package com.example.sbblogbusiness.aop;

import com.example.sbblogbusiness.entity.ExceptionLog;
import com.example.sbblogbusiness.repository.ExceptionLogRepository;
...
public class ExceptionLoggingAspect {
  ...
  @AfterThrowing(
      pointcut = "execution(* com.example.sbblogbusiness..*(..))",
      throwing = "exception")
