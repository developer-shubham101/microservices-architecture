...
public class SecurityConfig {
  ...
  public ReactiveJwtDecoder reactiveJwtDecoder(
    ...
    // Use Spring Security helper to create a ReactiveJwtDecoder from issuer location (JWKs discovery)
  ...
  public ReactiveClientRegistrationRepository clientRegistrationRepository(
      ...
      @Value("${spring.security.oauth2.client.registration.gateway-client.client-id}") String clientId,
      @Value("${spring.security.oauth2.client.registration.gateway-client.client-secret}") String clientSecret,
      @Value("${spring.security.oauth2.client.registration.gateway-client.redirect-uri}") String redirectUri) {
