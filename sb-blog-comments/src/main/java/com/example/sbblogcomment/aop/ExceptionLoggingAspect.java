package com.example.sbblogcomment.aop;

import com.example.sbblogcomment.entity.ExceptionLog;
import com.example.sbblogcomment.repository.ExceptionLogRepository;
...
public class ExceptionLoggingAspect {
  ...
  @AfterThrowing(pointcut = "execution(* com.example.sbblogcomment..*(..))", throwing = "exception")
